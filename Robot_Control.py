...
time.sleep(2)
minmum=[770,1250,520,500,500,1400]#[770,500,500,500,500,1400] 			the minimum/maximum PW for each servo. 
...
inc=[25,25,25,25,25,25]					# increase steps used with keyboard control
			...
			for i in range(axes):
				...
				if i == 0:							#left stick, x-y
					...
					if axis<=0:
						...
						if servopwm[active-1] > maxmum[active-1]:
							servopwm[active-1] = maxmum[active-1]
# next two blocks draw the graphic interface
